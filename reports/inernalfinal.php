            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for(var i=0;i<data.totalrecords;i++)
                        {
                            var CIA = data.data[i].EX01==null?0:data.data[i].EX01;
                            var CIAT = data.data[i].EX01==null?0:data.data[i].TEX01;
                            var MODEL = data.data[i].EX03==null?0:data.data[i].EX03;
                            var MODELT = data.data[i].EX03==null?0:data.data[i].TEX03;
                            var Assignment=data.data[i].EX04==null?0:data.data[i].EX04;
                            var attendance=data.data[i].EX05==null?0:data.data[i].EX05;
