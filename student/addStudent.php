            ...
            <form method="POST" action="addStudent.php" class="form-horizontal col-md-12 col-lg-12">
                <div class="col-sm-12 col-md-6 col-lg-6 ">
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Reg No</label>
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label"> First Name</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Last Name</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Batch</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Email</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Mobile Number</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Gender</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Age</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                                <input type="text" name="st_age" class="form-control" id="input1" placeholder="Age" required  autocomplete="off"/>
                            </div>
                    </div>
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">DOB</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                                    <input type='date' id='st_dob' name='st_dob' class="form-control" required  autocomplete="off"/>
                            </div>
                    </div>
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Aadhar Number</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Father Name</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Mother Name</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Door/Street Name</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Area/PO</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">City</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Pincode</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">State</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Nationality</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Community</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                            <label for="input1" class="col-sm-6  col-md-4 col-lg-4 control-label">Religion</label>
                            <div class="col-sm-6 col-md-8 col-lg-8">
